...
/* USER CODE END Boot_Mode_Sequence_1 */
  ...
  MX_USART3_UART_Init();
  /* USER CODE BEGIN 2 */
  Producer Producer_1 ( GPIOB , GPIO_PIN_0 ) ;
  Producer Flok ( GPIOB , GPIO_PIN_0 ) ;
  Producer_1.InsertItem(&SharedBuffer) ;
  Flok.InsertItem(&SharedBuffer);
  Consumer A ;
  volatile uint8_t tmp = A.RetrieveItem(&SharedBuffer) ;
  tmp = A.RetrieveItem(&SharedBuffer) ;
...
void vProducer_2(void *argument)
{
  /* USER CODE BEGIN vProducer_2 */
	Producer Producer_2 ( GPIOB , GPIO_PIN_14 ) ;
	/* Infinite loop */
	for(;;)
	{
		osDelay(1);
...
void vProducer_3(void *argument)
{
  /* USER CODE BEGIN vProducer_3 */
	Producer Producer_3 (GPIOD, GPIO_PIN_15 ) ;
	/* Infinite loop */
	for(;;)
	{
		osDelay(1);
...
void vProducer_4(void *argument)
{
  /* USER CODE BEGIN vProducer_4 */
	Producer Producer_4 (GPIOG, GPIO_PIN_6 ) ;
	/* Infinite loop */
	for(;;)
	{
		osDelay(1);
...
void vProducer_5(void *argument)
{
  /* USER CODE BEGIN vProducer_5 */
	Producer Producer_5 (GPIOE, GPIO_PIN_1);
	/* Infinite loop */
	for(;;)
	{
		osDelay(1);
